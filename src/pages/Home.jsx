...
// --- SVG Icon Components ---
const StudentIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-purple-600 mb-2" viewBox="0 0 20 20" fill="currentColor">
    ...
    const steps = [
        {
            ...
            description: 'Integrate attendance, grades, assignments, and behavioral data from your existing systems.',
        },
        {
            number: '02',
            title: 'AI Analysis',
            description: 'Our machine learning algorithms analyze patterns and identify early warning indicators.',
        },
        {
            number: '03',
            title: 'Risk Assessment',
            description: 'Students are categorized into risk levels with color-coded visual indicators.',
        },
        {
            number: '04',
            title: 'Intervention',
            description: 'Automated alerts to counselors and personalized support recommendations.',
        },
    ];
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                        Our AI system continuously analyzes multiple data points to provide early warning signs and actionable insights for student success.
                    </p>
                </div>
            ...
            <div className="relative bg-gradient-to-r from-blue-600 to-green-400 text-white text-center py-24 md:py-32 lg:py-40">
                <div className="container mx-auto px-4 z-10 relative">
                    ...
                    <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                        Predict, Prevent, and Support – AI-powered dropout prediction & counseling system
                    </p>
                    <div className="mt-8 flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                        <button className="bg-white text-blue-600 font-semibold px-8 py-3 rounded-lg shadow-md hover:bg-gray-100 transition-all duration-300 transform hover:scale-105">
                            Explore Features →
                        </button>
                        <button className="bg-gray-800 bg-opacity-40 text-white font-semibold px-8 py-3 rounded-lg border border-white hover:bg-opacity-60 transition-all duration-300 transform hover:scale-105">
                            View Demo Dashboard
                        </button>
                    </div>
                </div>
